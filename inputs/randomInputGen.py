...
# Written to the simulation file.

# Example From: https://www.pythonguis.com/tutorials/multithreading-pyqt-applications-qthreadpool/
# Shows Thread running concurrently with main window and outputs thread results to console
